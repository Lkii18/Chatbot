...
public class DatabaseChinese extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "Chatbot.db";
    private static final int DATABASE_VERSION = 1;

    private static final String TABLE_NAME = "placeC";
    ...
    private static final String TABLE_NAME2 = "commentC";
    ...
    public DatabaseChinese(@Nullable Context context) {
